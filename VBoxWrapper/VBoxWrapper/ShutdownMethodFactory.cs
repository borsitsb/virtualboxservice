...
namespace VBoxWrapper
{
    ...
    /// <summary>
    /// This is a default implementation, that will always return the "SaveState"-Shutdowntype
    /// </summary>
	public class ShutdownMethodFactory
	{
		public static ShutdownMethod createShutdownMethod()
		{
